...
class Mutes(VoiceMutes, commands.Cog, metaclass=CompositeMetaClass):
    ...
    @commands.command(name="الكتم_النشط")
    @commands.guild_only()
    ...
    @commands.command(name="تايم", usage="<users...> [time_and_reason]")
    @commands.guild_only()
    ...
    @commands.command(name="كتم", usage="<users...> [time_and_reason]")
    @commands.guild_only()
    ...
    @commands.command(
        name="كتم_قناة", aliases=["mutechannel", "channelmute"], usage="<users...> [time_and_reason]"
    )
    @commands.mod_or_permissions(manage_roles=True)
    ...
    @commands.command(name="فك_الكتم", usage="<users...> [reason]")
    @commands.guild_only()
    @commands.mod_or_permissions(manage_roles=True)
    async def unmute(
        self,
    ...
    @commands.command(name="فك_الكتم_إجباري", usage="<users...> [reason]", hidden=True)
    @commands.guild_only()
    @commands.mod_or_permissions(manage_roles=True)
    ...
    @commands.mod_or_permissions(manage_roles=True)
    @commands.command(name="فك_كتم_قناة", aliases=["unmutechannel", "channelunmute"], usage="<users...> [reason]")
    @commands.bot_has_guild_permissions(manage_permissions=True)
